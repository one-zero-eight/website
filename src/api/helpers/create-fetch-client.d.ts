// Based on https://github.com/openapi-ts/openapi-typescript/blob/0cc7ee77d28359c7901d9cd3b5733b70a050ea49/packages/openapi-fetch/src/index.d.ts
...
> =
  | {
      data: ParseAsResponse<
        Readable<SuccessResponse<ResponseObjectMap<T>, Media>>,
        Options
      >;
      error?: never;
      response: Response;

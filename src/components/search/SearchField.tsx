  ...
  return (
    ...
    >
      <div className="flex flex-row gap-2 md:basis-1/2">
        ...
        <button
          type="submit"
          className="mr-3 flex h-10 w-[93px] items-center justify-center gap-2 rounded-lg bg-brand-violet px-2 py-1 text-base font-normal leading-6 text-white shadow-[0px-0px-4px-#00000040] hover:bg-[#6600CC]"
        >

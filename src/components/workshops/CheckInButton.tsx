...
export function CheckInButton({ workshopId }: { workshopId: string }) {
  ...
  if (!isWorkshopActive(workshop)) {
    return (
      <p
        className={clsx(
          "rounded-box w-fit transform border border-[rgba(255,107,107,0.3)] bg-[rgba(255,107,107,0.15)] text-center leading-normal font-medium text-[#ff6b6b] backdrop-blur-sm dark:border-[rgba(255,107,107,0.3)] dark:bg-[rgba(255,107,107,0.15)]",
  ...
  if (checkedIn) {
    return (
      <button
        ...
        className="bg-inh-primary/80 rounded-box flex w-fit cursor-pointer items-center justify-center border border-[#ff6b6b]/20 px-2 py-1 text-[#ff6b6b] hover:border-[#ff5252]/40 hover:bg-[rgba(255,107,107,0.2)] hover:text-[#ff5252] disabled:cursor-not-allowed disabled:opacity-50"
        title="Check out"
      >

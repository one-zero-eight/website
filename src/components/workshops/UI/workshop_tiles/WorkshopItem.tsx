...
const WorkshopItem: React.FC<WorkshopItemProps> = ({
  ...
  return (
    ...
    >
      ...
      {!isWorkshopActive() && (
        <p className="pointer-events-none absolute bottom-1.5 left-1/2 z-[1] max-w-[calc(100%-12px)] -translate-x-1/2 transform rounded-md border border-[rgba(255,107,107,0.3)] bg-[rgba(255,107,107,0.15)] px-1.5 py-1 text-center text-[9px] font-semibold leading-normal text-[#ff6b6b] backdrop-blur-[8px] dark:border-[rgba(255,107,107,0.3)] dark:bg-[rgba(255,107,107,0.15)] sm:bottom-3 sm:rounded-xl sm:px-4 sm:py-2.5 sm:text-sm">

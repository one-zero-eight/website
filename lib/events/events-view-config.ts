...
export const viewConfig: ViewConfig = {
  categories: {
    "core-courses": {
      alias: "core-courses",
      title: "Core Courses",
      shortDescription: "Academic schedule for core courses in S24.",
    ...
    electives: {
      alias: "electives",
      title: "Electives",
      shortDescription: "Academic schedule for electives in S24.",
    ...
    sports: {
      alias: "sports",
      title: "Sports",
      shortDescription: "Schedule of sport classes in S24.",
      filtersTagTypes: [],

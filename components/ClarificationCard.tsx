...
export default function ClarificationCard(props: ClarificationProps) {
  return (
    <div className="flex flex-col justify-between items-center text-center px-4 py-8 my-3 rounded-3xl bg-primary w-max-125">
      ...
      <p className="text-sm text-text_secondary">{props.shortDescription}</p>
    </div>
  );
}

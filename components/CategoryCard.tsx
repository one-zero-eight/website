...
export default function CategoryCard(props: CategoryCardProps) {
  ...
  return (
    <Link
      key={props.slug}
      href={path}
      className="text-text-main hover:bg-primary-main shadow-5xl transition ease-in-out hover:shadow-5xl-m flex flex-col justify-between items-center border-4 border-border px-4 py-6 my-2 rounded-3xl text-center sm:w-80 lg:w-64 xl:basis-80 sm:w-fit"
    >

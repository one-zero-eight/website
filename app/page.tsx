...
export default async function Page() {
  return (
    <main className="p-12 sm:p-16">
      <h1 className="text-3xl text-center lg:text-left xl:text-4xl font-bold">InNoHassle ecosystem</h1>
      ...
      <h2 className="text-3xl xl:text-4xl font-medium mt-8 text-center">Choose the category</h2>
      <CategoryContainer/>
      <h3 className="text-3xl font-medium text-center lg:text-left mt-8">How it works?</h3>
